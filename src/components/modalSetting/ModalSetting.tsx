...
import ModalSettingDate from './ModalSettingDate';
import ModalSettingName from './ModalSettingName';
import ModalSettingPrice from './ModalSettingPrice';
import ModalSettingTinhTrang from './ModalSettingTinhTrang';
...
const ModalSetting = (props: PropsModalSetting) => {
    ...
    const { isModal, handleModalClose, dataSetting, isUpdate, dataUpdate } =
        props;
    //===============================================
    // state
    //===============================================
    ...
    const onFinish = (fieldsValue: any) => {
        ...
        if (!booleanDayEnd) {
            dateNgayHetHan = `${dayEndDate}/${dayEndMonth + 1}/${dayEndYear}`;
        }
            ...
            <Form
                ...
                <div className="box-modal-body">
                    ...
                    <ModalSettingDate
                        ...
                        setDayEnd={setDayEnd}
                        setRadioStart={setRadioStart}
                        setRadioEnd={setRadioEnd}
                    ...
                    />
                    <ModalSettingTinhTrang setState={setState} state={state} />
                </div>
